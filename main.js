// ============================================
// 🌸 REDX MINI BOT - FIXED MAIN.JS
// 👑 Developer: Abdul Rehman Rajpoot
// ============================================
...
const BOT_NAME = config.BOT_NAME || 'REDX MINI BOT';
const OWNER_NAME = config.OWNER_NAME || 'Abdul Rehman Rajpoot';
const OWNER_NUMBER = config.OWNER_NUMBER || ['923009842133'];

// ========== CHANNEL SETTINGS ==========
const CHANNEL_JID = config.CHANNEL_JID || '120363409338797582@newsletter';
...
// ========== GROUP ADMINS (REDX MINI BOT Style) ==========
...
function redxLog(message, type = 'info') {
    ...
    console.log(`${icons[type] || '📝'} [REDX MINI BOT-MINI] ${new Date().toISOString()}: ${message}`);
}
...
// ========== EXTRACT MESSAGE BODY (REDX MINI BOT Style) ==========
...
// ========== EXTRACT BUTTON ID (REDX MINI BOT Style) ==========
...
*© Powered by ${OWNER_NAME}*`;
    ...
    if (connection === 'close') {
        ...
        redxLog(`REDX MINI BOT Pair error: ${err.message}`, 'error');
